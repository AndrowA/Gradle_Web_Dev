...
public class BTMS
{
  ...
  public BTMS()
  {
    ...
    schedules = new ArrayList<DriverSchedule>();
  }
  ...
  {
    DriverSchedule aSchedule = schedules.get(index);
    return aSchedule;
  }

  public List<DriverSchedule> getSchedules()
  {
    List<DriverSchedule> newSchedules = Collections.unmodifiableList(schedules);
    return newSchedules;
  }
  ...
  public void delete()
  {
    ...
    {
      DriverSchedule aSchedule = schedules.get(schedules.size() - 1);
      aSchedule.delete();
      schedules.remove(aSchedule);
    }
