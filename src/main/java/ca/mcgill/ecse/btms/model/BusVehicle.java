...
public class BusVehicle
{
  ...
  public BusVehicle(String aLicencePlate, boolean aInRepairShop, BTMS aBTMS)
  {
    ...
    {
      throw new RuntimeException("Cannot create due to duplicate licencePlate. See http://manual.umple.org?RE003ViolationofUniqueness.html");
    }
  ...
  public boolean setLicencePlate(String aLicencePlate)
  {
    ...
    if (anOldLicencePlate != null && anOldLicencePlate.equals(aLicencePlate)) {
      return true;
    }
